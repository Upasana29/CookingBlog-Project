...
exports.homepage = async(req,res)=>{
    ...
    try{
        ...
        res.render('index',{title:'Cooking Blog - Home',categories,food});//when homepage is default page
 ...
 */
 exports.exploreCategories = async(req,res)=>{
    ...
    try{
        ...
        const categories = await Category.find({}).limit(limitNumber);
        res.render('categories',{title:'Cooking Blog - Categories',categories});//when homepage is default page
    } catch(error){
        res.status(500).send({message: error.message || "Error Occured"});
    }
}
 ...
 */
 exports.exploreCategoriesByID = async(req,res)=>{
    ...
    try{
        ...
        res.render('categories',{title:'Cooking Blog - Categories',categoryById});//when homepage is default page
    } catch(error){
        res.status(500).send({message: error.message || "Error Occured"});
    }
 ...
 */
 exports.exploreRecipe = async(req,res)=>{
    ...
    try{
        ...
        res.render('recipe',{title:'Cooking Blog - Recipe',recipe});//when homepage is default page
    } catch(error){
        res.status(500).send({message: error.message || "Error Occured"});
    }
